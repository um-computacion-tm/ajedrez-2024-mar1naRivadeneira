...
class TestRook(unittest.TestCase):
    ...
    def test_move_vertical_desc(self):
        board = Board()
        rook = Rook("WHITE", board)
        possibles = rook.possible_moves_orthogonal(4, 1, 5, 1)
        self.assertTrue(possibles)
           
    def test_move_vertical_asc(self):
        board = Board()
        rook = Rook("WHITE", board)
        possibles = rook.possible_moves_orthogonal(4, 1, 3, 1)
        self.assertTrue(possibles)
    ...
    def test_move_vertical_desc_with_not_own_piece(self):
        ...
        rook = Rook("WHITE", board)
        board.set_piece(4, 1, rook)
        possibles = rook.possible_moves_orthogonal(4, 1, 6, 1)
        self.assertTrue(possibles)
        
    def test_move_horizontal_derecha(self):
        board = Board(for_test=True)
        rook = Rook("WHITE", board)  
        possibles = rook.possible_moves_orthogonal(5, 1, 5, 3)
        self.assertTrue(possibles)
           
    def test_move_horizontal_izquierda(self):
        board = Board(for_test=True)
        rook = Rook("WHITE", board)  
        possibles = rook.possible_moves_orthogonal(5, 7, 5, 5)
        self.assertTrue(possibles)
    ...
    def test_move_horizontal_derecha_with_not_own_piece(self):
        ...
        rook = Rook("WHITE", board)
        board.set_piece(5, 1, rook)
        possibles = rook.possible_moves_orthogonal(5, 1, 5, 5)
        self.assertTrue(possibles)
    ...
    def test_move_horizontal_izquierda_with_own_piece(self):
        ...
        possibles = rook.possible_moves_orthogonal(5, 7, 5, 4)
        self.assertTrue(possibles)
    ...
    def test_move_horizontal_izquierda_with_not_own_piece(self):
        ...
        rook = Rook("WHITE", board)
        board.set_piece(5, 7, rook)     
        possibles = rook.possible_moves_orthogonal(5, 7, 5, 3)
        self.assertTrue(possibles)
        
    def test_move_diagonal_desc(self):
        board = Board()
        rook = board.get_piece(col=0, row=0)
        is_possible = rook.possible_moves_orthogonal(
            from_row=0,
            from_col=0,
            to_row=1,
            to_col=1,
